export const RESUME_DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      highlights: [
        'Lifted funnel conversion by shipping A/B-tested landing pages and funnel improvements in React and Next.js',
        'Connected siloed marketing and growth tools into a single pipeline, eliminating manual handoffs and surfacing data the team had been flying blind on'
      ]
    },
    {
      ...
      highlights: [
        'Lead engineer and technical partner to an early-stage founder',
        'Shipped concept-to-MVP on time across AWS, Hono, and a Tauri + React app for web and mobile',
        'Ran market validation that produced a decisive no-go and closed the engagement cleanly'
      ]
    },
    {
      ...
      highlights: [
        'Built and sold a casino floor management system with visual analytics for slot performance, hot/cold zones, and revenue',
        'Shipped supporting slot machine software and mobile product demos across WPF, MSSQL, and Xamarin'
      ]
    }
  ],
  skills: [
    ...
    { label: 'AI Tooling', details: 'Claude Code, MCP, LLM application development' }
  ],
  projects: [
    {
      title: 'sample.fit',
